...
主機能として、ポーンのペルソナ設定を拡張やロアブック形式の辞書によるModコンテンツの理解補助等があります。
...
| `{UN}場面を丁寧に描写する{END}` | ユニークイベント発生時のみ反映（実験的機能）|

![ペルソナサンプル](images/persona_sample.png)
## カスタマイズについて

Dictionariesにはユーザーが任意で変更できる「辞書」がまとまっています。各項目のコメント（説明文）を参考に、必要な部分のみ編集してください。
